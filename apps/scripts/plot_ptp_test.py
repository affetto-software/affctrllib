...
def plot_ddq(data, **sfparam) -> None:
    fig, ax = plt.subplots()
    for i in [0, 1, 2]:
...
# Local Variables:
# jinx-local-words: "basedir ddq dq env noqa noshow png py savefig sfparam usr xlabel ylabel"
# End:
